            ...
            <div className="max-w-[1330px] mx-auto px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="relative group overflow-hidden rounded-none aspect-[4/3] lg:aspect-auto lg:h-full min-h-[500px]">
                        ...
                        {/* Red Box Overlay */}
                        <div className="absolute bottom-6 left-6 right-6 bg-[#09365E] p-8 rounded-xl text-white shadow-xl transform transition-transform duration-300 group-hover:-translate-y-2">
